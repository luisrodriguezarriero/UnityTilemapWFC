...
/*
[ExecuteInEditMode]
class OverlapTileWFC : MonoBehaviour{
	...
	public OverlappingTileModel model = null;
 ...
 #if UNITY_EDITOR
[CustomEditor (typeof(OverlapTileWFC))]
public class WFCGeneratorEditor : Editor {
	public override void OnInspectorGUI () {
		OverlapTileWFC generator = (OverlapTileWFC)target;
