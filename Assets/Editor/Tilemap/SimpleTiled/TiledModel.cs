...
{
    class TiledModelCreator : ModelCreator
    {
        public TiledModelCreator(SubSet subSet, int width, int height, bool periodic) : 
            base(1, periodic, false)
        {
            
            foreach (WfcSprite tile in subSet.Sprites){
        ...
        public override void Save(UnityEngine.Tilemaps.Tilemap outout, int[] observed, int MX, int MY)
        {
